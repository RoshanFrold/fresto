module.exports = {
  ...
  embed: {
    ...
    footertext: "Coded By FRG | FRESTO",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=1185888978893803582&permissions=0&scope=bot`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/gk8uwyNaKx`,
    VoteURL: process.env.VoteURL || `https://google.com`,
    Website: `https://frestodev.rf.gd`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
  ...
  slash: {
    global: true,
    guildID: process.env.GUILD_ID || "1182928228386619422", // for slash command
  },
};
